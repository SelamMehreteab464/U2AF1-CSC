...
#SBATCH --error=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/sbatch/w2d2_log/lsf_%j_%x.err
#SBATCH --output=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/sbatch/w2d2_log/lsf_%j_%x.out
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=smehrete@ucsc.edu

# Define paths
GUPPY_PATH=/private/groups/brookslab/bin/ont-guppy_v6.4.6/bin
INPUT_DIR=/private/groups/brookslab/smehrete/RNA_modification/20230715_clone2_csc_dmso/w2d2/20230714_1850_MN20099_FAW07040_3d2dec7f/fast5
# Input directory with FAST5 files
OUTPUT_DIR=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/wt2dmso2_output # Output directory for basecalled data
