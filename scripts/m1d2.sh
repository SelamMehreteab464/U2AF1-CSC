...
#SBATCH --error=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/sbatch/m1d2_log/lsf_%j_%x.err
#SBATCH --output=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/sbatch/m1d2_log/lsf_%j_%x.out
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=smehrete@ucsc.edu

# Define paths
GUPPY_PATH=/private/groups/brookslab/bin/ont-guppy_v6.4.6/bin
INPUT_DIR=/private/groups/brookslab/smehrete/RNA_modification/c1dmsocsc_rep2/m1d2/20231018_1447_MN20223_FAX01937_a623fcb2/fast5
# Input directory with FAST5 files
OUTPUT_DIR=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/mt1dmso2_output # Output directory for basecalled data
