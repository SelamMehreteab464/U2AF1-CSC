...
#SBATCH --error=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/sbatch/w1c2_log/lsf_%j_%x.err
#SBATCH --output=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/sbatch/w1c2_log/lsf_%j_%x.out
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=smehrete@ucsc.edu

# Define paths
GUPPY_PATH=/private/groups/brookslab/bin/ont-guppy_v6.4.6/bin
INPUT_DIR=/private/groups/brookslab/smehrete/RNA_modification/c1dmsocsc_rep2/w1c2-3/20231018_1535_MN19950_FAX02471_23df9c7f/fast5
# Input directory with FAST5 files
OUTPUT_DIR=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/wt1csc2_output  # Output directory for basecalled data
