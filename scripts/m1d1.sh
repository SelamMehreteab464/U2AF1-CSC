...
#SBATCH --error=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/sbatch/m1d1_log/lsf_%j_%x.err
#SBATCH --output=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/sbatch/m1d1_log/lsf_%j_%x.out
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=smehrete@ucsc.edu

# Define paths
GUPPY_PATH=/private/groups/brookslab/bin/ont-guppy_v6.4.6/bin
INPUT_DIR=/private/groups/brookslab/smehrete/RNA_modification/clone1cscdmsorep1/m1dmso_7/20231011_1648_MN20099_FAX25174_e65539bf/fast5
# Input directory with FAST5 files
OUTPUT_DIR=/private/groups/brookslab/smehrete/RNA_modification/basecalling_output/mt1dmso1_output # Output directory for basecalled data
